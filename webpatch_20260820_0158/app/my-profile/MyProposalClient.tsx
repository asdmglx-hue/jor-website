          ...
          <div style={{ background: bg, borderRadius: 16, padding: '18px 20px', marginBottom: 20, position: 'relative', overflow: 'hidden' }}>
            ...
            <div className="featured-mobile-layout" style={{ display: 'none' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 6 }}>
                ...
                <div style={{ background: 'rgba(255,255,255,0.18)', borderRadius: 8, padding: '4px 9px', flexShrink: 0 }}>
                  <span style={{ color: '#fff', fontSize: 11, fontWeight: 800, whiteSpace: 'nowrap' }}>Credits: {available}</span>
                </div>
              </div>
