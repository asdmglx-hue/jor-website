        ...
        return (
          <div style={{ background: bg, borderRadius: 16, padding: '18px 20px', marginBottom: 20, position: 'relative', overflow: 'hidden' }}>
            ...
            <div className="featured-mobile-layout" style={{ display: 'none' }}>
              ...
              <div style={{ fontSize: 13, color: isRunning ? '#FFE9D2' : '#D4D1F7', lineHeight: 1.45, marginBottom: 10 }}>
                {isRunning
              ...
              <div style={{ display: 'inline-block', background: 'rgba(255,255,255,0.18)', borderRadius: 8, padding: '5px 10px', marginBottom: 12 }}>
                <span style={{ color: '#fff', fontSize: 11, fontWeight: 800, whiteSpace: 'nowrap' }}>Featured Credits: {available}</span>
              </div>
              <div style={{ display: 'flex', gap: 8 }}>
                {available > 0 ? (
                  ...
                  <Link href="/plans?plan=featured" style={{ flex: 1, display: 'block', textAlign: 'center', padding: '9px 0', borderRadius: 10, background: '#fff', color: isRunning ? '#E8620A' : '#534AB7', fontWeight: 800, fontSize: 13, textDecoration: 'none' }}>
                    Buy Credits
                  </Link>
                )}
