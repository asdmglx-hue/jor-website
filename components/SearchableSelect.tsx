          ...
          <div style={{ maxHeight: 220, overflowY: 'auto' }}>
            {pinnedOption && (
              <div
                ...
                <span>{pinnedOption.label}</span>
                {value === pinnedOption.value && (
                  <svg style={{ marginLeft: 'auto' }} width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#534AB7" strokeWidth="2.5" strokeLinecap="round">
