...
export default function ReportButton({ proposalId }: { proposalId: string }) {
  ...
  useEffect(() => {
    ...
    // Use session subscription data — it's saved fresh at login
    // and subscription_expiry tells us if it's still valid
      ...
      <div style={{ textAlign: 'center', marginTop: 12 }}>
        <button
          ...
          style={{
            ...
            fontSize: 12, color: '#9C8FC0', textDecoration: 'underline',
            padding: 0, display: 'inline-flex', alignItems: 'center', gap: 4,
          }}
        >
          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#9C8FC0" strokeWidth="2.5">
