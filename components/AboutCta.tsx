  ...
  return (
    <div style={{ textAlign: 'center', background: '#EEEDFE', borderRadius: 20, padding: '32px' }}>
      ...
      <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
        ...
        {!loggedIn && (
          <Link href="/register-otp" style={{ padding: '12px 24px', borderRadius: 12, background: '#fff', border: '1.5px solid #534AB7', color: '#534AB7', fontWeight: 700, fontSize: 14, textDecoration: 'none' }}>Post a Rishta</Link>
        )}
      </div>
    </div>
  );
