    ...
    return (
      <div style={{ marginBottom: 16 }}>
        <div style={{
          ...
          color: '#B0ADCB', fontWeight: 700, fontSize: 15, marginBottom: 10,
          userSelect: 'none',
        }}>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#B0ADCB" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div style={{
          ...
          <svg width="18" height="18" viewBox="0 0 24 24" fill="#B0ADCB" xmlns="http://www.w3.org/2000/svg">
