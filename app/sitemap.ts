...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: 'https://jor.com.pk/submit', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: 'https://jor.com.pk/subscription', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
