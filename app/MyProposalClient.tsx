      ...
      <div style={{
        ...
        <div className="my-account-right" style={{ display: 'flex', flexDirection: 'column', gap: 8, alignItems: 'flex-end' }}>
          ...
          <div className="my-account-actions-wrap" style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
            {/* Verify Now moved to full-width above pending banner on mobile */}
        ...
        if (label === 'Pending') return (
          <>
            ...
            {proofPending && (
              ...
              return (
                <button className="verify-now-banner-btn" onClick={() => { setVerifyModalOpen(true); trackEvent('verify_now_click', { source: 'mobile_banner' }); }}
