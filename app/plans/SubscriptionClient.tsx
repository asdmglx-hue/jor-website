  ...
  const plans = [
    {
      ...
      features: ['Publish your profile', 'Unlimited Local Proposals', 'Unlimited Overseas Proposals', 'Unlock Contact and Photos', 'Use Advanced Search Filters', 'Pause or Edit your profile', 'Validity for 1 month', '24 hours support'],
      note: undefined,
    },
    {
