            ...
            <div className="featured-mobile-layout" style={{ display: 'none' }}>
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                {available > 0 ? (
                  ...
                  <Link href="/plans?plan=featured" style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '9px 0', borderRadius: 10, background: '#fff', color: isRunning ? '#E8620A' : '#534AB7', fontWeight: 800, fontSize: 13, textDecoration: 'none', minHeight: 38 }}>
                    Buy Credits
                  </Link>
                )}
