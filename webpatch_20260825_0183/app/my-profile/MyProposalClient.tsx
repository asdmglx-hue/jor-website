        ...
        <div className="my-account-right" style={{ display: 'flex', flexDirection: 'column', gap: 8, alignItems: 'flex-end' }}>
          ...
          <div className="my-account-actions" style={{ display: 'flex', gap: 8, flexWrap: 'nowrap', alignItems: 'center' }}>
            ...
            {user.status === 'pending' && (() => {
              ...
              const allUploaded = !!(user.cnic_front_url && user.cnic_back_url && user.education_document_url && user.guardian_cnic_front_url && user.guardian_cnic_back_url);
              // Also show when not doc-verified (admin removed a photo or not all approved)
              return anyRejected || !user.is_doc_verified || (!allUploaded && !hasPendingVerification);
            })() && (
