          ...
          <div style={{ background: bg, borderRadius: 16, padding: '18px 20px', marginBottom: 20, position: 'relative', overflow: 'hidden' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 14, position: 'relative' }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <div className="featured-btns-row" style={{ display: 'flex', gap: 10, flexWrap: 'wrap', alignItems: 'flex-end' }}>
                  {available > 0 ? (
                    ...
                    <Link href="/plans?plan=featured" className="featured-btn-mobile" style={{ display: 'inline-block', textAlign: 'center', padding: '9px 20px', borderRadius: 10, background: '#fff', color: isRunning ? '#E8620A' : '#534AB7', fontWeight: 800, fontSize: 13, textDecoration: 'none', whiteSpace: 'nowrap' }}>
                      Buy Credits
                    </Link>
                  )}
